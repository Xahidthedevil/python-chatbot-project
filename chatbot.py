...
owm = OWM('bb928b232dd30fa30dab5dbeeec46251')

import urllib.request
from ipstack import GeoLookup
geo_lookup = GeoLookup("be73db058b4c76d4f90c0054eda4deb8")
...
print(
    "Hello, I'm a Python Chatbot!\nI was created by 'Team XYZ'"
)
time.sleep(1)
returnname()
instructions()
